...
var IndecisionApp = function (_React$Component) {
  ...
  _createClass(IndecisionApp, [{
    ...
    value: function componentDidMount() {
      try {
        var json = localStorage.getItem('options'); // get the data of the specified key (option in this case)
        var options = JSON.parse(json); // Convert JSON string to Javascript Object
...
var Header = function Header(props) {
  return (// Can do this for JSX --> Can add as much JSX as we want just like when we defining our template
    React.createElement(
      'div',
      null,
      React.createElement(
